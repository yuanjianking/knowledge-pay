                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0)" onclick="$eb.createModalFrame('编辑','{:Url('add_source')}?id={{d.id}}&special_type={$special_type}',{h:900,w:1300})">
                                    <i class="fa fa-paste"></i> 编辑
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" onclick="$eb.createModalFrame('编辑内容','{:Url('update_content')}?id={{d.id}}&field=content&special_type={$special_type}',{h:900,w:800})">
                                    <i class="fa fa-paste"></i> 内容
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" onclick="$eb.createModalFrame('编辑简介','{:Url('update_content')}?id={{d.id}}&field=detail&special_type={$special_type}',{h:900,w:800})">
