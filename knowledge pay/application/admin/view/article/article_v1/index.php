...
<div class="layui-fluid" style="background: #fff">
    <div class="layui-tab layui-tab-brief" lay-filter="tab">
        <ul class="layui-tab-title">
            ...
            <a href="{eq name='type' value='2'}javascript:;{else}{:Url('add_article',['type'=>2])}{/eq}">图文添加</a>
            </li>
        </ul>
    </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="store_name" class="layui-input" placeholder="请输入图文名称,关键字,编号">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="alert alert-info" role="alert">
                        列表[图文名称],[排序]可进行快速修改,双击或者单击进入编辑模式,失去焦点可进行自动保存
...
<script>
    ...
    layList.tableList('List',"{:Url('article_list')}",function (){
        return [
            ...
            {field: 'title', title: '图文名称',edit:'title',align: 'center'},
